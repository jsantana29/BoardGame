...
public class Player2 {
    ...
    public Player2(int health, int money, int position, int mines, int shots, int missiles, int dewitos, int hitDay, boolean launched) {
        this.health = health;
        this.mines = mines;
    ...
    public String toString() {
        return "Player2{" + "health=" + health + ", money=" + money + ", position=" + position + ", mines=" + mines + ", shots=" + shots + ", missiles=" + missiles + ", dewitos=" + dewitos + ", hitDay=" + hitDay + ", launched=" + launched + '}';
    }
    ...
    public void Player2Moved(int move){
    ...
    public int isMoneyLost(){
        if(money == 0){
            JOptionPane.showMessageDialog(null, "Damn Player 2! You are too poor to take money from!");
        }
        else if(money > 0){
            money -= 100;
        }
    ...
    public void isDead(){
        if(health <= 0){
            JOptionPane.showMessageDialog(null, "Player 2 can no longer continue due to Obamacare! Player 1 wins!");
            System.exit(0);
        }
    }
